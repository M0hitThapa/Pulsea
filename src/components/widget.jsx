...
export const Widget = () => {
  ...
  return (
    <div className="widget fixed bottom-2 left-4 z-50">
      <Popover>
        ...
        <PopoverContent
          ...
          align="start"
          sideOffset={8}
          className="w-[350px] p-6 bg-card widget"
        >
          {submitted ? (
            <div>
            ...
            <div>
              <div className="mb-6">
                <h3 className="text-2xl font-bold text-neutral-900 mb-2 font-title">
                  Share Your Thoughts
                </h3>
              ...
              <form onSubmit={submit} className="space-y-4">
                <div>
                  ...
                  <Input
                    ...
                    className="h-11 border-neutral-300 focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition-all rounded-md shadow-input"
                  />
                </div>
