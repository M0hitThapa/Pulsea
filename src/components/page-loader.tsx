...
export function PageLoaderComponent({ isLoading = true }: PageLoaderProps) {
    ...
    return (
        <div
            className={`fixed inset-0 z-50 flex items-center justify-center bg-neutral-50 dark:bg-neutral-950 transition-opacity duration-300 ${isLoading ? "opacity-100" : "opacity-0 pointer-events-none"
                }`}
        >
            <div className="absolute inset-0 pointer-events-none">
                <div
                    className="absolute inset-0 bg-gradient-to-r from-transparent via-white to-transparent dark:via-neutral-900"
                    style={{
