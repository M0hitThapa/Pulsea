      ...
      >
        ...
        >
          <svg
            ...
            viewBox="0 0 24 24"
            fill="currentColor"
            className="icon icon-tabler icons-tabler-filled icon-tabler-bubble-text size-10 text-blue-500 p-1 border border-neutral-200 dark:border-neutral-900 rounded-md shadow-inner shadow-neutral-300 dark:shadow-neutral-700"
          >
