  ...
  return (
    <Container className="max-w-3xl py-10 space-y-8 ">
      <div className="mx-2">
        ...
        <div className="mt-20">
          <h1
            className=" text-xl md:text-3xl font-semibold tracking-tight text-shadow-lg
        "
          >
            Start collecting feedback
          </h1>
          <p className="text-muted-foreground mt-2 text-sm md:text-md font-medium">
            Add this embed code to your website to activate your widget.
          </p>
        </div>

        {/* Code Block */}
        <div className="mt-10 flex justify-between items-start bg-neutral-100 text-neutral-900 dark:bg-neutral-900 dark:text-neutral-100 rounded p-5 border border-neutral-300 dark:border-neutral-700 shadow-lg">
