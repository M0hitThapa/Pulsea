...
import { DeleteProjectComponent } from "@/components/delete-project-component";
  ...
  return (
    <ul className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 mx-auto">
      {projects.map((project: Project) => (
        <li
          key={project.id}
          className="shadow-inner shadow-neutral-950 dark:shadow-neutral-100 transition-all duration-300"
        >
